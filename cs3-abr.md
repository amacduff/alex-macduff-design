...
<section id="two" class="spotlights">
	<section>
		<div class="image {{ page.style }}">
			<img src="img/abr-1.png" alt="" data-position="top center" />
		</div>
		<div class="content">
			<div class="inner">
				<header class="major">
	...
	<section>
		<div class="image {{ page.style }}">
			<img src="img/abr-2.png" alt="" data-position="top center" />
		</div>
		<div class="content">
			<div class="inner">
				<header class="major">
	...
	<section>
		<div class="image {{ page.style }}">
			<img src="img/abr-3.png" alt="" data-position="25% 25%" />
		</div>
		<div class="content">
			<div class="inner">
				<header class="major">
	...
	<section>
		<div class="image {{ page.style }}">
			<img src="img/abr-4.png" alt="" data-position="25% 25%" />
		</div>
		<div class="content">
			<div class="inner">
				<header class="major">
	...
	<section>
		<div class="image {{ page.style }}">
			<img src="img/abr-5.png" alt="" data-position="25% 25%" />
		</div>
		<div class="content">
			<div class="inner">
				<header class="major">
